...
class AdapterController extends Controller {
	...
	public function javascript_approvalSystem() {
		$data['prefix'] = 'provider/approvalSystem';
		$data['defaultPage'] = Helper::providerUserAccess('home', 'approvalSystem', 0) ? 'home' : 'welcome';
		$data['nodeUrl'] = self::$nodeUrl;
		$data['webUrl'] = self::$webUrl;
		$data['loginRoute'] = "provider.login";
		return view('javascript_view', $data);
