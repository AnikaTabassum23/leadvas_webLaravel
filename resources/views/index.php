...
<html lang="en">
  <head>
	...
	<meta property="og:image" content="<?php echo base_url("resource/img/fb_share.jpg"); ?>" />
	...
	<meta name="twitter:image" content="<?php echo base_url("resource/img/fb_share.jpg"); ?>" />
	...
	<meta itemprop="image" content="<?php echo base_url("resource/img/fb_share.jpg"); ?>" />
    ...
    <link href="<?php echo base_url('resource/css/overwrite.css'); ?>" rel="stylesheet">
	<!-- Font -->
	<link href="<?php echo base_url('resource/fonts/open-sans/stylesheet.css'); ?>" rel="stylesheet">
	<!-- Font icons -->
	<link href="<?php echo base_url('resource/css/font-awesome.css'); ?>" rel="stylesheet">
    <link href="<?php echo base_url('resource/fonts/pe-icon-7-stroke/css/pe-icon-7-stroke.css'); ?>" rel="stylesheet">
	<link href="<?php echo base_url('resource/fonts/pe-icon-7-stroke/css/helper.css'); ?>" rel="stylesheet">
	<!-- Animate css -->
    <link href="<?php echo base_url('resource/css/animate.css'); ?>" rel="stylesheet">	
    <!-- flexslider -->	
	<link href="<?php echo base_url('resource/css/flexslider.css'); ?>" rel="stylesheet">
	<!-- Owl carousel -->
    <link href="<?php echo base_url('resource/css/owl.carousel.css'); ?>" rel="stylesheet">
    <link href="<?php echo base_url('resource/css/owl.theme.css'); ?>" rel="stylesheet">
    <link href="<?php echo base_url('resource/css/owl.transitions.css'); ?>" rel="stylesheet">
	<!-- Custom styles for this template -->
    <link href="<?php echo base_url('resource/css/style.css'); ?>" rel="stylesheet">
	<!-- Theme skin -->
	<link href="<?php echo base_url('resource/skins/default.css'); ?>" rel="stylesheet" />
	<!-- Slider -->
	<link href="<?php echo base_url('resource/css/slider.css'); ?>" rel="stylesheet" />
  ...
  <body>
		...
		<div class="navbar navbar-default navbar-fixed-top" role="navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="<?php echo site_url(); ?>"><img src="<?php echo base_url('resource/img/leadvas.png'); ?>" alt="" /></a>
				</div>
				<div class="collapse navbar-collapse">
					...
					<div class="navbar-right">
						<a href="<?php echo site_url('login'); ?>" class="btn btn-gray">Login</a>
						<a href="<?php echo site_url('demo'); ?>" class="btn btn-primary">Try Demo</a>
					</div>	
				</div><!--/.nav-collapse -->
			</div>
		</div>	
			...
			<div class="container">
				<div class="row text-center wow fadeInUp" data-wow-delay="0.4s">
					<div class="col-md-10 col-md-offset-1">
						...
						<!-- <p class="btn-inline">
							<a href="<?php //echo site_url('demo'); ?>" class="btn btn-primary btn-lg">Try Demo</a>
						</p> -->
						<div class="home-slider">
							<div class="slider-wrapper">
								<div class="imac-device">
									<ul class="slides">
										<li>
											<a href="#"><img src="<?php echo base_url('resource/img/slider/img1.jpg'); ?>" alt="" /></a>
										</li>
										<li>
											<a href="#"><img src="<?php echo base_url('resource/img/slider/img2.jpg'); ?>" alt="" /></a>
										</li>
										<li>
											<a href="#"><img src="<?php echo base_url('resource/img/slider/img3.jpg'); ?>" alt="" /></a>
										</li>
										<li>
											<a href="#"><img src="<?php echo base_url('resource/img/slider/img4.jpg'); ?>" alt="" /></a>
										</li>
									</ul>
								</div>
							</div>
							<img src="<?php echo base_url('resource/img/imac.png'); ?>" class="img-responsive" alt="" />
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-7 wow fadeInLeft" data-wow-delay="0.4s">
					<img src="<?php echo base_url('resource/img/device.png'); ?>" class="img-responsive" alt="" />
				</div>
						...
						<div class="screenshot-slider">
							<div class="screenshot-wrapper">
								<div class="flexslider text-center">
									<ul class="slides">
										<li>
											<a href="#"><img src="<?php echo base_url('resource/img/screenshot/img1.jpg'); ?>" alt="" /></a>
										</li>
										<li>
											<a href="#"><img src="<?php echo base_url('resource/img/screenshot/img2.jpg'); ?>" alt="" /></a>
										</li>
										<li>
											<a href="#"><img src="<?php echo base_url('resource/img/screenshot/img3.jpg'); ?>" alt="" /></a>
										</li>
										<li>
											<a href="#"><img src="<?php echo base_url('resource/img/screenshot/img4.jpg'); ?>" alt="" /></a>
										</li>
									</ul>
								</div>
							</div>
							<img src="<?php echo base_url('resource/img/browser.png'); ?>" class="img-responsive" alt="" />
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row wow fadeInDown" data-wow-delay="0.4s">
				<div class="col-md-4">
					<div class="pricing-wrapper">
						...
						<div class="pricing-bottom">
							<a href="<?php echo site_url('demo'); ?>" class="btn btn-default btn-bordered btn-lg">Get it now</a>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="pricing-wrapper">
						<form action="<?php echo site_url('package/make_plan'); ?>" method="post">
				...
				<div class="col-md-4">
					<div class="pricing-wrapper">
						...
						<div class="pricing-bottom">
							<a href="<?php echo site_url('#contact'); ?>" class="btn btn-default btn-bordered btn-lg">Request Now</a>
						</div>
					</div>
				</div>	
			</div>
					...
					<div class="col-md-8 col-md-offset-2">
						...
						<form>
							<fieldset class="subscribe-form">
								<button class="subscribe-button" type="button" onclick="location.href = '<?php echo site_url("demo"); ?>';">Get Your Free Demo</button>
							</fieldset>	
						</form>	
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-4">
						...
						<div class="testimoni-author">
							...
							<img src="<?php echo base_url('resource/img/testimoni/avatar1.png'); ?>" alt="" />
						</div>
					</div>
					<div class="col-md-4">
						<div class="testimonial">
						...
						<div class="testimoni-author">
							...
							<img src="<?php echo base_url('resource/img/testimoni/avatar2.png'); ?>" alt="" />
						</div>
					</div>
					<div class="col-md-4">
						<div class="testimonial">
						...
						<div class="testimoni-author">
							...
							<img src="<?php echo base_url('resource/img/testimoni/avatar3.png'); ?>" alt="" />
						</div>
					</div>
				</div>
			</div>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-10 col-md-offset-1 wow fadeInDown" data-wow-delay="0.4s">
						<form id="contactform" action="<?php echo site_url('home/contact'); ?>" method="post" class="validateform" name="leaveContact">
							<div class="clearfix"></div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					...
					<p><?php echo date('Y'); ?> &copy; Copyright <a href="http://www.iisbd.com/" target="_blank">INNOVATION Information System</a> All rights Reserved.</p>
				</div>
			</div>
		</div>	
	</footer>
	...
	<!-- Fixed navigation -->
	<script src="<?php echo base_url('resource/js/navigation/waypoints.min.js'); ?>"></script>
	<script src="<?php echo base_url('resource/js/navigation/jquery.smooth-scroll.js'); ?>"></script>		
	<script src="<?php echo base_url('resource/js/navigation/navbar.js'); ?>"></script>	
	<!-- Wow -->
	<script src="<?php echo base_url('resource/js/wow/wow.min.js'); ?>"></script>
	<script src="<?php echo base_url('resource/js/wow/setting.js'); ?>"></script>
	<!-- flexslider -->
	<script src="<?php echo base_url('resource/js/flexslider/jquery.flexslider.js'); ?>"></script>
	<script src="<?php echo base_url('resource/js/flexslider/setting.js'); ?>"></script>
	<!-- counters -->
	<script src="<?php echo base_url('resource/js/counters/jquery.appear.js'); ?>"></script>
	<script src="<?php echo base_url('resource/js/counters/stellar.js'); ?>"></script>
	<script src="<?php echo base_url('resource/js/counters/setting.js'); ?>"></script>
	<!-- Owl carousel -->
	<script src="<?php echo base_url('resource/js/owlcarousel/owl.carousel.js'); ?>"></script>
    <script src="<?php echo base_url('resource/js/owlcarousel/setting.js'); ?>"></script>
	<!-- Totop -->
	<script src="<?php echo base_url('resource/js/totop/jquery.ui.totop.js'); ?>"></script>	
	<script src="<?php echo base_url('resource/js/totop/setting.js'); ?>"></script>
	<!-- Slider Range -->
	<script src="<?php echo base_url('resource/js/bootstrap-slider.js'); ?>"></script>
	<!-- Contact validation -->
	<script src="<?php echo base_url('resource/js/validation.js'); ?>"></script>
	<!-- Customn javascript -->
	<script src="<?php echo site_url('adapter/javascript'); ?>"></script>
	<script src="<?php echo base_url('resource/js/custom.js'); ?>"></script>
	<script src="<?php echo base_url('resource/js/custom_index.js'); ?>"></script>
