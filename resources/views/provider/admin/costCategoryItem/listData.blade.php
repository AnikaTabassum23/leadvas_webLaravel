            ...
            <table cellspacing="0" class="responsive table table-striped table-bordered">
                <thead>
                    <tr>
                        ...
                        <th width="20%" data="2">Last Update</th>
                ...
                @foreach($categoryItems as $categoryItem)
                    <tr>
                        ...
                        @if($access->edit || $access->destroy)
                        <td>@if($access->edit)<i class="fa fa-edit" id="edit" data="{{$categoryItem->id}}"></i>@endif 
                            @if($access->destroy)<i class="fa fa-trash-o" id="delete" data="{{$categoryItem->id}}"></i>@endif
                        </td>
                        @endif
                    </tr>
                @endforeach
