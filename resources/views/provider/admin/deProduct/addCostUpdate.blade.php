<style>
    ...
    <div class="row printable" id="mainDiv">
        <div class=col-md-12>
            <form type="create" id="productInvoiceFrom" class="form-load form-horizontal mt0" action="{{route('provider.admin.provider.admin.addCostUpadteAction')}}" method="POST" callback="refreshArea" autocomplete="off">
                {{csrf_field()}}
                <table id="dtHorizontalExample" class="table table-bordered table-sm input-table">
                    ...
                    <tbody id="opportunity_product_plus" class="amountPurpose">
                        @foreach($productWiseCostMaster as $key => $productWiseCostMaster)
                        <tr class="new_product_row">
                                    ...
                                    <div class="form-group pl10 mb0">
                                        <div class="col-sm-11 pl15 pr5" id="product_id_view">
                                            <select required name="item[]" id="product_id" data-fv-row=".col-sm-11" data-fv-icon="false" class="product_id select2 form-control adv-search product_select append_option">
                                                ...
                                                <option value="{{$costCalculationItem->id}}" @if($productWiseCostMaster->item == $costCalculationItem->id) selected @endif>{{$costCalculationItem->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group pl10 mb0">
                                        <div class="col-sm-11 pl15 pr5" id="category_id_view">
                                            <select required name="category[]" id="category_id" data-fv-row=".col-sm-11" data-fv-icon="false" class="category_id select2 form-control adv-search category_select append_option">
                                                ...
                                                <option value="{{$costCategoryItem->id}}"  @if($productWiseCostMaster->category_item == $costCategoryItem->id) selected @endif>{{$costCategoryItem->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <td id="quantity_td">
                                <div class="form-group pl10 pr10 mb0">
                                    <input required name="quantity[]" id="quantity" class="form-control quantity" placeholder="Qty" value="{{$productWiseCostMaster->quantity}}">
                            ...
                            <td>
                                <div class="form-group pl10 pr10 mb0">
                                    <input disabled name="unit[]" id="unit" class="form-control " required value="{{$productWiseCostMaster->unit}}">

                                </div>
                            </td>
                            <td>
                                <div class="form-group pl10 pr10 mb0">
                                    <input type="text" name="purchase_price[]" id="purchase_price" placeholder=" Price" class="form-control purchase_price" title="Purchase Price" required data-fv-regexp="true" data-fv-regexp-regexp="^[0-9+\s\.]+$" data-fv-regexp-message="Purchase price can consist of number only" value="{{$productWiseCostMaster->price}}">
                                </div>
                            </td>
                            <td>
                                <div class="form-group pl10 pr10 mb0">
                                    <input disabled name="per_product_total[]" placeholder="Total" class="form-control per_product_total" id="per_product_total" value="{{$productWiseCostMaster->product_subtotal_price}}">
                                    <input type="hidden" class="per_product_total_amount custon_single_p_amount" name="per_product_total_amount[]" id="per_product_total_amount" value="{{$productWiseCostMaster->product_subtotal_price}}">
                                </div>
                            </td>
                            <td>
                                <div class="form-group pl10 pr10 mb0">
                                    <textarea name="remarks[]" class="form-control" placeholder="Enter Remarks" rows="1">{{$productWiseCostMaster->remarks}}</textarea>
                                </div>
                            </td>
                        ...
                        <div class="col-md-7 col-lg-7">
                            <div class="form-group col-lg-12 col-md-12 mt10 pull-right" id="less_box">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="targetProfit" name="target_profit" placeholder="Transport Cost" kl_virtual_keyboard_secure_input="on" data-fv-regexp="true" data-fv-regexp-regexp="^[0-9+\s\.]+$" data-fv-regexp-message="Amount can consist of number only" value="{{$deProduct->target_profit}}" readonly>
                                    </div>
                                </div>
                            </div><br>
                            <div class="form-group col-lg-12 col-md-12 mt10 pull-right" id="less_box">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="input-group">
                                        <span class="input-group-addon"></span>
                                        <input type="text" class="form-control" id="target_mrp" name="target_mrp" placeholder="Less Amount" kl_virtual_keyboard_secure_input="on" data-fv-regexp="true" data-fv-regexp-regexp="^[0-9+\s\.]+$" data-fv-regexp-message="Amount can consist of number only" value="{{$deProduct->target_mrp}}" readonly>
                                    </div>
                                </div>
                            </div>
                            <br>
                            <div class="form-group col-lg-12 col-md-12 mt10 pull-right" id="less_box">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="input-group">
                                        <span class="input-group-addon"></span>
                                        <input type="text" class="form-control total_mrp" id="total_mrp" name="total_mrp" placeholder="Less Amount" kl_virtual_keyboard_secure_input="on" data-fv-regexp="true" data-fv-regexp-regexp="^[0-9+\s\.]+$" data-fv-regexp-message="Amount can consist of number only" value="{{$deProduct->total_mrp}}">
                                    </div>
                                </div>
                            </div>
                            <br>
                            <div class="form-group col-lg-12 col-md-12 mt10 pull-right" id="less_box">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="input-group">
                                        <span class="input-group-addon"></span>
                                        <input type="text" class="form-control" id="profitPercentage" name="profitPercentage" placeholder="Less Amount" kl_virtual_keyboard_secure_input="on" data-fv-regexp="true" data-fv-regexp-regexp="^[0-9+\s\.]+$" data-fv-regexp-message="Amount can consist of number only" value="{{$deProduct->profitPercentage}}" readonly>
                                    </div>
                                </div>
                            </div>
                            <br>
                            ...
                            <div class="form-group col-md-6 col-lg-6">
                                <div class="form-group col-md-12 col-lg-12" style="text-align: right;">
                                    <h4 style="font-weight: 300 !important; font-size: 14px;">
                                        <span class="color" id="subTotalAmount" class="subTotalAmount"></span><span>(Tk)</span>
                    ...
                    <tr class="new_product_row">
                        ...
                        <td>
                            <div class="form-group pl10 pr10 mb0">
                                ...
                                <input type="hidden" class="per_product_total_amount custon_single_p_amount" name="per_product_total_amount[]" id="per_product_total_amount">
                            </div>
                        </td>
                        <td>
                            <div class="form-group pl10 pr10 mb0">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#productInvoiceFrom .custon_single_p_amount').each(function(){
            ...
            $("#productInvoiceFrom").on('change', '.product_select', function(e) {
                ...
                $('.purchase_price').on('keyup', function(){
                    ...
                    $(this).closest("tr").find('.per_product_total_amount').val(ctn);

                    $(this).each(function(){
                        subTotalAmount = subTotalAmount + Number($('.per_product_total_amount').val());
                    });
                    ...
                    if (productId ==0 || productId == '') {
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                unit_selector.val(data.productSearch.unit);
                                qtyFeedbackStatusvalue.text(data.quantity);
                                productPrice.val(data.sales_price);
                                productTotalPrice.val(data.sales_price);
                                quantity.val(1);
            ...
            $('#productInvoiceFrom').on("keyup", ".purchase_price", function (e) {
                ...
                $(this).closest("tr").find('#per_product_total').val(ctn);
                $(this).closest("tr").find('.per_product_total_amount').val(ctn);
                var customNetTotalAmount = 0;
                $('.custon_single_p_amount').each(function(){
                    var value = Number($(this).val());
                    customNetTotalAmount += value;
                });
                $('#subTotalAmount').text(customNetTotalAmount.toFixed(2));
            ...
            $('#productInvoiceFrom').on("keyup", ".total_mrp", function (e) {
                ...
                var old_net_cost = {{$deProduct->net_cost}};
                var subTotalAmount = Number($('#subTotalAmount').text());
            ...
            $('#productInvoiceFrom').on("keyup", "#quantity", function () {
                ...
                var subTotalAmount = 0;
                var q_value = $parentTr.find('.qtyFeedbackStatusvalue').text();
                var elmQty = $(this).val();
                if(Number(elmQty) > Number(q_value))
                {
                    // $("button[type='submit']").prop('disabled', true);
                    // $('.pub-plus').hide();
                    // $parentTr.find('.qtyFeedback').html('<strong class="text-danger">Quantity out of stock!</strong>');
                } 
                else{
                    $('.pub-plus').show();
                    ...
                    var singleProductPrice = $parentTr.find('.product_price').val();
                    var productToalAmount = singleProductPrice * elmQty;
    
                    $parentTr.find('.product_total_price').val(productToalAmount);
                }
    
            });
    
            $('#productInvoiceFrom').on("keyup", ".ctn_qty", function () {
                var $parentTr = $(this).parents('tr').first();
                var q_value = $parentTr.find('.qtyFeedbackStatusvalue').text();
                var elmQty = $parentTr.find('.ctn_qty_status').text();
                if(Number(elmQty) > Number(q_value))
                {
                //    $("button[type='submit']").prop('disabled', true);
                //    $parentTr.find('.qtyFeedback').html('<strong class="text-danger">Quantity out of stock!</strong>');
