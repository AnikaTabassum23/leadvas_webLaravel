...
<form type="update" panelTitle="{{$panelTitle}}" class="form-load form-horizontal group-border stripped">
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10 col-md-9">
            <input autofocus required name="percentage" placeholder="Percentage" class="form-control" value="{{$department->percentage}}">
        </div>
    </div>
    <div class="form-group">
        <div class="col-lg-offset-2">
            <button type="submit" class="btn btn-default ml15">Update Percentage</button>
        </div>
    </div>
</form>