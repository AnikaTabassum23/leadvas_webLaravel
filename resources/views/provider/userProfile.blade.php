            ...
            <div class="tabs mb20">
               ...
               <div class="tab-content" id="myTabContent">
                  <div id="update_profile" class="tab-pane fade active in">
                     <form type="update" action="{{route('provider.approvalSystem.userProfileUpdate')}}" data-fv-excluded="" class="form-load form-horizontal group-border stripped">
                        {{csrf_field()}}
                  ...
                  <div id="change_password" class="tab-pane fade pb0 mb15">
                     <form type="create" action="{{route('provider.approvalSystem.changePassword')}}" data-fv-excluded="" class="form-load form-horizontal group-border stripped">
                        {{csrf_field()}}
                        <!-- End .form-group  -->
                        <div class="form-group form-group-vertical">
   				   ...
   				   <div id="timezone" class="tab-pane fade pb0 mb15">
                        <form type="update" action="{{route('provider.approvalSystem.changeTimeZone')}}" data-fv-excluded="" class="form-load form-horizontal group-border stripped">
                           {{csrf_field()}}
