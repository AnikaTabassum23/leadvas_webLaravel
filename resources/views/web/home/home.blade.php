						...
						<div class="home-slider">
							<div class="slider-wrapper">
								<div class="imac-device">
									<ul class="slides">
										<li>
											<a href="#"><img src="{!! asset('resource/img/slider/img1.jpg') !!}" alt="" /></a>
										</li>
										<li>
											<a href="#"><img src="{!! asset('resource/img/slider/img2.jpg') !!}" alt="" /></a>
										</li>
										<li>
											<a href="#"><img src="{!! asset('resource/img/slider/img3.jpg') !!}" alt="" /></a>
										</li>
										<li>
											<a href="#"><img src="{!! asset('resource/img/slider/img4.jpg') !!}" alt="" /></a>
										</li>
									</ul>
								</div>
							</div>
							<img src="{!! asset('resource/img/imac.png') !!}" class="img-responsive" alt="" />
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-7 wow fadeInLeft" data-wow-delay="0.4s">
					<img src="{!! asset('resource/img/device.png') !!}" alt="image description" class="img-responsive">
				</div>
						...
						<div class="screenshot-slider">
							<div class="screenshot-wrapper">
								<div class="flexslider text-center">
									<ul class="slides">
										<li>
											<a href="#"><img src="{!! asset('resource/img/screenshot/img1.jpg')!!}" alt="" /></a>
										</li>
										<li>
											<a href="#"><img src="{!! asset('resource/img/screenshot/img2.jpg')!!}" alt="" /></a>
										</li>
										<li>
											<a href="#"><img src="{!! asset('resource/img/screenshot/img3.jpg')!!}" alt="" /></a>
										</li>
										<li>
											<a href="#"><img src="{!! asset('resource/img/screenshot/img4.jpg')!!}" alt="" /></a>
										</li>
									</ul>
								</div>
							</div>
							<img src="{!! asset('resource/img/browser.png')!!}" class="img-responsive" alt="" />
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-md-4">
						...
						<div class="testimoni-author">
							...
							<img src="{!! asset('resource/img/testimoni/avatar1.png')!!}" alt="" />
						</div>
					</div>
					<div class="col-md-4">
						<div class="testimonial">
						...
						<div class="testimoni-author">
							...
							<img src="{!! asset('resource/img/testimoni/avatar2.png')!!}" alt="" />
						</div>
					</div>
					<div class="col-md-4">
						<div class="testimonial">
						...
						<div class="testimoni-author">
							...
							<img src="{!! asset('resource/img/testimoni/avatar3.png')!!}" alt="" />
						</div>
					</div>
				</div>
			</div>
