	...
	<link rel="stylesheet" href="{!! asset('public/frontend/css/jquery.flipster.css') !!}">
	<link rel="stylesheet" href="{!! asset('public/frontend/css/icomoon.css') !!}">
	<link rel="stylesheet" href="{!! asset('public/frontend/css/jquery-ui.css') !!}">
	<link rel="stylesheet" href="{!! asset('public/frontend/css/pogoslider.css') !!}">
	...
	<link rel="stylesheet" href="{!! asset('public/frontend/css/placeorder.css') !!}">
