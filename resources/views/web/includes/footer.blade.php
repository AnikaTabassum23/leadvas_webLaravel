							...
							<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
								<div class="tg-column">
									<strong class="tg-logo">
										<a href="javascript:void(0);"><img src="{!! asset('public/frontend/images/logo.png') !!}" alt="image description"></a>
									</strong>
									<div class="tg-description">
										<p>Our Purpose in fashion is customization and niche customization. To create a collection in consideration of our customer's demands.</p>
									</div>
									<ul class="tg-contactinfo">
										<li>
											<i class="icon-phone-handset"></i>
											<span>+88 0191 9887156</span>
										</li>
										<!-- <li>
										...
										<li>
											...
											<span><a href="mailto:support@domain.com">support@demeraki.com</a></span>
										</li>
										<li>
										...
										<div class="tg-widgetcontent">
											...
											<ul class="tg-timinginfo">
												<li>
													...
													<span>09:00am to 10:00pm</span>
												</li>
												<li>
													<span>Friday: </span>
													<span>3:00pm to 10:00pm</span>
												</li>
												<!-- <li>
													<span>Sunday: </span>
													<span>Closed</span>
...
{{-- @section('js')
    ...
    <script src="{!! asset('public/frontend/js/jquery.flipster.min.js') !!}"></script>
    <script src="{!! asset('public/frontend/js/owl.carousel.min.js') !!}"></script>
    <script src="{!! asset('public/frontend/js/pogoslider.js') !!}"></script>
